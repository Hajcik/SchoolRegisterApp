...
$("#sendmessage").click(function (event) {
    ...
    if ($("#choose").val() === "User") {
        ...
        else connection.invoke("SendMessageToUser", message);
    } else { connection.invoke("SendMessageToGroup", message);  }
    $("#message").val("").focus();
});
...
document.getElementById("message").addEventListener("sendmessage", submitOnEnter);
